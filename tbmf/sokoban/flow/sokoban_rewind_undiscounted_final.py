...
@rllm.rollout(name="sokoban_rewind_undiscounted_final")
async def sokoban_rewind_undiscounted_final_flow(task: Task, config: AgentConfig) -> Episode:
                ...
                if segment_steps:
                    trajectories.append(
                        Trajectory(
                            ...
                            steps=segment_steps,
                            reward=None,
                            metadata={"role": PLAY_ROLE, "segment_idx": segment_idx},
                        )
                    )
                break
