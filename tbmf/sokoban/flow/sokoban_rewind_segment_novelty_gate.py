...
@rllm.rollout(name="sokoban_rewind_segment_novelty_gate")
async def sokoban_rewind_segment_novelty_gate_flow(task: Task, config: AgentConfig) -> Episode:
    ...
    async with session:
        ...
        while True:
            ...
            segment_events: list[BranchEvent] = []
            # Board observations produced by this segment's effective model actions.
            ...
            # Variant 3 novelty gate: did this segment's model actions reach any
            # board state not already in (segment prefix C_0..C_start) U (segment
            # i-1's observations)? The prefix is the active path before this
            # segment ran.
