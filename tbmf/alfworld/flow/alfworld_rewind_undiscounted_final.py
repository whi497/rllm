"""ALFWorld rewind reward variant: undiscounted final reward."""
...
@rllm.rollout(name="alfworld_rewind_undiscounted_final")
async def alfworld_rewind_undiscounted_final_flow(task: Task, config: AgentConfig) -> Episode:
