"""WebShop rewind reward variant: undiscounted final reward."""
...
@rllm.rollout(name="webshop_rewind_undiscounted_final")
async def webshop_rewind_undiscounted_final_flow(task: Task, config: AgentConfig) -> Episode:
